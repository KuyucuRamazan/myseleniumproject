...
public class Day12_Synchronization extends TestBase {
    ...
    public void explicitWait() throws InterruptedException {
        ...
        //wait does two things: 1. waits for the element. 2. returns it as web element so need to use findelement
        ...
        /* NOTE: This code is hidden because the Hello World text is hidden for about 5 secands
       We should wait for the element
